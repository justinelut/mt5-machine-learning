...
def get_mt5_data(symbol, days=30, timeframe=mt5.TIMEFRAME_M5):
    """
    Fetch historical data from MT5.
    :param symbol: The trading symbol.
    :param days: Number of days to backtest.
    :param timeframe: Timeframe for data (default: M5).
    """
...
# ------------------------------
days_to_backtest = 30  # Change this to backtest for different time periods

df = get_mt5_data(symbol, days=days_to_backtest)
if df is not None:
